...
class _CartScreenState extends State<CartScreen> {
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  getCustomFont("\$${modelOther.price}", 14,
                                      brownColor, 1,
                                      fontWeight: FontWeight.w800),
                                  getVerSpace(FetchPixels.getPixelHeight(10)),
  ...
  Widget proceedButton(BuildContext context) {
    return getPaddingWidget(
      EdgeInsets.symmetric(horizontal: horspace),
      getButton(context, brownColor, "Proceed", Colors.white, () {
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            getCustomFont(
                                "\$${modelCart.price}", 16, brownColor, 1,
                                fontWeight: FontWeight.w800)
                          ],
                        ),
                      ),
                    ...
                    Column(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          onTap: () {
                            setState(() {
                              cartLists.removeWhere((key, value) =>
                                  value.name == list[index].name);
                            });
                          },
                        ),
